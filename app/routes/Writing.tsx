...
const entries = [
  ...
  },
  {
    text: (
      <>
        <p>Be it their color, their shine, or the arrangement of it all I couldn’t tell you,<br />but there was something in her hair and her eyes that made my heart stop in an instant. <br />Honestly. <br /> I’d trudge home in the pouring rain after class, no hood, water dripping onto my face, unsure whether any of it was real or if I’d simply imagined it in a moment of madness.
        </p>
      </>
    ),
    image: 'images/27.jpg',
  ...
  },
  {
    text: (
      <>
        {/* <p>God I wanted you so much. Really, truly, it’s all I can do to trudge from here to there and distract my heart with fleeting fulfillment, all in imitation, never in replacement, of you.  */}
        <p>So I guess the past few years I can’t say I haven’t felt the distance. Distance man, always distance. Always falling in love from afar, always moving the borders around. Justifying the transience of a come-and-go kind of lover with whatever explanation was convenient at the time, finding a way to always hold something in reserve. <br /><br />Though we were two halves fractured from the same block, our irregularities and imperfections mirrored only in each other,<br />she sold love to the highest bidder,<br /> <i>and I guess I’d just been coming up short.</i>
        </p>
      </>
    ),
    image: 'images/2.jpg',
  },
  {
    text: (
      <>
        <p>Trust me, I still remember all of it, down to the finest detail: the smell of her hair fresh-washed; the silhouette of her face opposite mine; the way she laughed eyes-closed and carefree. It was all right there at the front of my mind all day, moments when I felt like part of a larger whole, connected to another at the heart, god how much do I miss that. Though it crumbled despite my best intentions, realistically I didn't see any other way. Love could exist and grow only in a world without borders, and any effort I made to wrangle it into some structured understanding was misled. From somewhere inside my get-it-all-right tendencies was the need to make it all align and fit properly, with defined edges and nothing overlapping. <br /><br />Like I said, I still remember: her dorky shoes, the ones I made fun of; her eyebrows strong and razor sharp; the pierce of her gaze cutting right to the bone; her sense of humor and the way it melted into mine; the way I felt inside whenever I was around her, no matter how briefly. I used to just ride the bus around town, jumping from line to line, anything to get further away from my apartment. Because in my apartment was my phone, and if I was home all I’d ever think about was picking up, calling you.<br /><br /> 
        </p>
      </>
    ),
    image: 'images/37.jpg',
